...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 p-6">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            <h1 style="font-size: 60px">SGIS-Z</h1>
        </div>
        <h1>SINGBEOGO GLOBAL INTERNATIONAL SERVICE</h1>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                Cette plateforme est la propriété de SGIS-Z.
            </div>

            <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                Version v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
            </div>
        </div>
    </div>
</div>
